...
**Preliminary**: Add an image of the final map here

![Preliminary version of the possible result](images/Workshop1/Step4/export-finish-map.jpg){width="90%" fig-align="center"}
...
![](images/new_empty_map.png){width="80%" fig-align="center"}
...
A new map will always open with a basemap. Esri has about 20 different basemaps available. We will start with the default. 
...
Let's add our first data layers to our map.

When you add an item to your map, it will show up under your Layers. When you want to see the layer properties, you can either use the menu on the right hand column to view its properties or use the "..." 
...
From the **Layers** panel, click on the add layer button. Search 'Your organization' for 'UCSB OSM Paths'. There should be only one result.
...
* aside *
Next to your campus profile, is a "tic tac toe" menu with a drop-down menu of the Esri Apps. There are many tools here, but for the context of this workshop, we will be focusing on ArcGIS Online and the Map Viewer. 
...
![](images/Workshop1/Step2/basemap-menu-location.png){width="40%" fig-align="center"}
...
![](images/Workshop1/Step2/basemap-light-gray-canvas.png){width="90%" fig-align="center"}
...
![](images/Workshop1/Step3/drawing-sketch-layer-menu.png){width="40%" fig-align="center"}
...
![](images/Workshop1/Step3/drawing-line-vector.gif){width="90%" fig-align="center"}
...
![](images/Workshop1/Step3/drawing-line-style.png){width="90%" fig-align="center"}
...
![](images/Workshop1/Step3/drawing-circle-vector.gif){width="90%" fig-align="center"}
...
![](images/Workshop1/Step4/export-print-menu.png){width="40%" fig-align="center"}
...
![](images/Workshop1/Step4/export-layout-menu.png){width="90%" fig-align="center"}
...
![](images/Workshop1/Step4/export-save-as.png){width="40%" fig-align="center"}
...
![](images/Workshop1/Step4/export-download-image.png){width="90%" fig-align="center"}
