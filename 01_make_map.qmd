...
(it would be nice if we could put our map into an iframe, but 
...
This time, navigate to the feature layer `UCSB Campus Buildings` 
by first finding the "From Maps to Analysis" group. 
