...
From the **Layers** panel, click on the add layer button and select "My groups" from the dropdown menu. The content from all the groups you belong to will be listed here. Select the group "From Maps to Analysis" if you have too many groups to easily find it.
