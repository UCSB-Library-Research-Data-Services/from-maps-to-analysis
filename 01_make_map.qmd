...
![Preliminary version of the possible result](images/export-finish-map-2.png){#fig-prelim width="80%" fig-align="center"}
...
Some of the bike racks are too close together. For point data, we have the option of using proportional symbols or clustered symbols to solve this visual clutter.

**To do**: Instructions for using clustered symbols for the bike racks layer to reduce visual clutter.
...
![Jon's results are a bit different](images/export-finish-map-2.png){width="90%" fig-align="center"}
