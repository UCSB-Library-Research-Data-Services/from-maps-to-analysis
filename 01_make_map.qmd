...
With that introduction, you now have the opportunity to start creating your own map.  The goal here is to create a map that reflects some of bike infrastructure on campus, and then to annotate on top of that some of your personal experience as a bicyclist or pedestrian on campus.
...
- Draw points where you were in a (near-)accident on the bike path, either as bicyclist of pedestrian.
