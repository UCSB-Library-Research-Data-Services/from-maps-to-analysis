...
2.  Add feature layers from the UCSB campus
3.  Draw annotations on top of the map
4.  Prepare the map for presentation and export it

As we will describe under [Other approaches](#sec-other-approaches) at the end of this lesson, there are many tools and techniques that can be used to create such a map. An advantage of using a GIS tool such as ArcGIS Online, and the central motivation for using GIS in this lesson, is that a GIS tool allow maps elements to be interpreted and manipulated as data, and in this way spatial analysis becomes possible.
...
[At the end of our session we should end up with something like this](https://arcg.is/0iD4jS0){target="_blank"}

![Preliminary version of the possible result](images/Workshop1/final_map.png){#fig-prelim}

<br>

Our final interactive map is also embedded below:

<iframe width="900" height="700" allow="local-network-access; geolocation" title="Workshop campus bike map" src="https://ucsb.maps.arcgis.com/apps/mapviewer/index.html?configurableview=true&amp;webmap=2b16d246ee4c4321852712b9b4652b74&amp;theme=light&amp;scroll=false&amp;center=-119.847894,34.414117&amp;scale=9027.977411">
...
-   `Basemap`: there are many provided by ArcGIS Online
-   `Layers`: your own and/or those shared by others
-   `Legend`: The symbology used on your map
-   `Save and open...`: Where you save your content
...
![open your menu bar to find the `save` icon](images/save.png){height="50%"}

-   There will be a blue dot next to the `save` icon until you save
-   You can organize your all of your content into folders
-- Let's make a folder for all of our work today. **Bike Map Workshop**
...
![Adding a layer](images/Workshop1/Step1/add-layers_small.gif){#fig-addinglayer}
...
![Reorder feature layers](images/Workshop1/Step1/reorder-layers_small.gif){#fig-reorderlayers fig-align="center"}
...
Your data can be visualized, selected, or analysed based on the columns of the attribute table. We will see later how you can leverage these attributes to set the symbology of a layer according to categories or quantities that are in the attribute table. You can also compute new attributes either based on other attributes or by performing analysis with other layers' information. We will cover analysis tools [in our second workshop](02_intro_gis.html).

::: {.callout-note collapse="true" title="Save often."}
Now that you have added the layers to your map, it's a good idea to save it again. 

![Save as dialog in ArcGIS Online](images/Workshop1/Step1/save-as.png){#fig-saveas width="30%" fig-align="center"}
...
![Selecting a bike parking symbol from the Government category](images/Workshop1/Step2/symbology-select-symbol.png){#fig-bikeparking width="90%" fig-align="center"}
...
![Basemap option in the left menu bar](images/Workshop1/Step2/basemap-menu-location.png){#fig-basemapoption width="40%" fig-align="center"}
...
![Map with Light Gray Canvas basemap](images/Workshop1/Step2/basemap-light-gray-canvas.png){#fig-lightgray width="90%" fig-align="center"}
...
![Sketch layer option in the left menu](images/Workshop1/Step3/drawing-sketch-layer-menu.png){#fig-sketchlayer width="40%" fig-align="center"}
...
::: {.callout-tip collapse="true"}
## Challenge: Drawing lines in a sketch layer
...
::: {.callout-tip collapse="true"}
## Challenge: Drawing circles in a sketch layer
...
![Drawing a circle on the map](images/Workshop1/Step3/drawing-circle-vector.gif){#fig-drawingcircle width="90%" fig-align="center"}
...
![Print option in the left menu bar](images/Workshop1/Step4/export-print-menu.png){#fig-printoption width="30%" fig-align="center"}
...
![Map export layout configuration panel](images/Workshop1/Step4/export-layout-menu.png){#fig-exportlayout width="90%" fig-align="center"}
...
![Saving exported map from the Exports panel](images/Workshop1/Step4/export-save-as.png){#fig-savingmap width="40%" fig-align="center"}
...
![Downloading the exported map image from ArcGIS Online content](images/Workshop1/Step4/export-download-image.png){#fig-downloadmap width="90%" fig-align="center"}

::: {.callout-warning collapse="true"}
# Public sharing
You can share your map publicly and embed it on a website, just like we did at the beginning of this lesson. However, for this to work, you need to set the visibility of all your map layers to public.
:::

<hr>

# Other approaches {#sec-other-approaches}
...
# Caveats of using ArcGIS Online {#sec-caveats}
...
ArcGIS Online is a powerful too, to be sure. But to use it in a way that supports open, reproducible science, we recommend that you:

- Export newly-created feature layers as Shapefiles, and/or export attributes tables as CSV files, and make those files preserved and citable by storing in a data repository. Do not consider ArcGIS Online to be any kind of long-term repository.
