...
For example, if you click on the three dots on the right of a feature layer you can access their *attribute table* by selecting `Show table`.
...
::: {.callout-note collapse="true" title="Save early. Save often."}
