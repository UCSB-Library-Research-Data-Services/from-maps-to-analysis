...
## Workshop 2 - Exploring more geospatial data

2-3 hours workshop using ArcGIS Online to conduct basic GIS data exploration and visualization.
...
Intro to spatial analysis and zonal statistics
-   buffering
-   interpolation
-   zonal statistics
-   raster calculation
